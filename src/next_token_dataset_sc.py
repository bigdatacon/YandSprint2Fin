...
class NextTokenDataset(Dataset):
    ...
    Для последовательности токенов [w1, w2, w3, w4]:
    - X: [CLS] w1 w2 w3 [SEP]
    - Y: w1 w2 w3 w4 [SEP]
    
    Y смещен относительно X на 1 токен вправо
    """
    ...
    def __getitem__(self, idx):
        ...
        # Для задачи next token prediction:
        # X: все токены, кроме последнего
        # Y: все токены, кроме первого (смещение на 1 вправо)
